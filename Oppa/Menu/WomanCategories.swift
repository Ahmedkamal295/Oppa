...
class WomanCategories: UIViewController {
...
extension WomanCategories: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! WomanCategoriesCell
...
extension WomanCategories : UICollectionViewDelegateFlowLayout {
