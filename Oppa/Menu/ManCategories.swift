...
class ManCategories: UIViewController {
...
extension ManCategories: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! ManCategoriesCell
...
extension ManCategories : UICollectionViewDelegateFlowLayout {
