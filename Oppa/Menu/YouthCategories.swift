...
class YouthCategories: UIViewController {
...
extension YouthCategories: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! YouthCategoriesCell
...
extension YouthCategories : UICollectionViewDelegateFlowLayout {
